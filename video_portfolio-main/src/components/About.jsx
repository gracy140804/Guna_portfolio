...
import stackImage from '../assets/about/guna_face.jpg';
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <p className="text-lg font-bold mb-12 leading-relaxed max-w-3xl text-red-50">
            Hi, my name is <span className="text-black text-xl font-black mx-1 tracking-wide uppercase">Gunasekar K</span>, a passionate Structural Engineer based in Tamil Nadu, dedicated to structural analysis, reinforced concrete design, and construction materials.
          </p>

          {/* Horizontal Skills Row (Transparent & Large) */}
          <div className="flex flex-wrap items-center gap-4 mt-8">
            {['AUTOCAD', 'STAAD PRO', 'REVIT', 'ANSYS', 'MS OFFICE'].map((skill, index) => (
              <div 
                key={skill}
                data-aos="zoom-in" 
